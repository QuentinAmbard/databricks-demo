...
# MAGIC %sql CREATE TABLE IF NOT EXISTS sales_history USING delta LOCATION '/mnt/quentin-demo-resources/retail/sales/forecast';
...
# MAGIC   GROUP BY date
# MAGIC  ) x
# MAGIC GROUP BY year, CAST(DATE_FORMAT(date, 'u') as Integer)
...
with mlflow.start_run():
  ...
  mlflow.pyfunc.log_model("model", conda_env=conda_env, python_model=FbProphetWrapper(model))  
